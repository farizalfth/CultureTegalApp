...
class PencapaianView extends GetView<PencapaianController> {
  ...
  Widget _buildBadgesTab() {
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final String imgPath = badge['image_url'] ?? '';
        final String fullImgUrl = controller.getImageUrl(imgPath);
  ...
  Widget _buildLeaderboardTab() {
    if (controller.leaderboard.isEmpty) {
      return Center(
        child: Text(
          "Papan peringkat belum tersedia.",
          style: TextStyle(color: Colors.grey.shade500),
        ),
      );
    }
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final String? pic = user['profile_picture'];
              ...
              CircleAvatar(
                ...
                child: ClipOval(
                  child: pic != null && pic.isNotEmpty
                      ? CachedNetworkImage(
                          imageUrl: controller.getImageUrl(pic),
                          fit: BoxFit.cover,
                          width: 40,
                          height: 40,
